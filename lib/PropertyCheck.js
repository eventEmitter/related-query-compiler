(function() {
    ...
    let classDefinition = {
        ...
        , validate: function(input) {
            ...
            else return Promise.reject(new Error(`[${this.parent.nodeName}] Expected one of the types ${this.checks.join(', ')} for the property ${this.propertyName}, got type ${type(input[this.propertyName])}!`));
        }
    };
